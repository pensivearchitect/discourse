...
I18n.defaultLocale = "en", I18n.fallbacks = !1, I18n.defaultSeparator = ".", I18n.locale = null, I18n.PLACEHOLDER = /(?:\{\{|%\{)(.*?)(?:\}\}?)/gm, I18n.fallbackRules = {}, I18n.pluralizationRules = {en: function (e) {
    ...
    function f(e) {
        return e ? (!O[e] && z && require("./lang/" + e), O[e]) : M.fn._lang
    }
    ...
    function I(e) {
        var t = e._i, n = e._f;
        return null === t || "" === t ? null : ("string" == typeof t && (e._i = t = f().preparse(t)), M.isMoment(t) ? (e = i({}, t), e._d = new Date(+t._d)) : n ? c(n) ? T(e) : w(e) : D(e), new r(e))
    }
    ...
    for (ut.DDDD = t(ut.DDD, 3), s.prototype = {set: function (e) {
        ...
        var n, s, r = M.isDuration(e), i = "number" == typeof e, o = r ? e._data : i ? {} : e, u = B.exec(e);
    ...
    }, M.version = R, M.defaultFormat = J, M.updateOffset = function () {
    }, M.lang = function (e, t) {
        return e ? (t ? d(e, t) : O[e] || f(e), M.duration.fn._lang = M.fn._lang = f(e), void 0) : M.fn._lang._abbr
        ...
        var t = j((M(this).startOf("day") - M(this).startOf("year")) / 864e5) + 1;
    ...
    }}, L = 0; nt.length > L; L++)N(nt[L].toLowerCase().replace(/s$/, ""), nt[L]);
    ...
    for (L in st)st.hasOwnProperty(L) && (P(L, st[L]), A(L.toLowerCase()));
    P("Weeks", 6048e5), M.duration.fn.asMonths = function () {
        ...
        return e + n
    }}), z && (module.exports = M), "undefined" == typeof ender && (this.moment = M), "function" == typeof define && define.amd && define("moment", [], function () {
        return M
    })
