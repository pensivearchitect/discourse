...
I18n.defaultLocale = "en", I18n.fallbacks = !1, I18n.defaultSeparator = ".", I18n.locale = null, I18n.PLACEHOLDER = /(?:\{\{|%\{)(.*?)(?:\}\}?)/gm, I18n.fallbackRules = {}, I18n.pluralizationRules = {en: function (e) {
    ...
    function C(t) {
        ...
        n === e ? t._d = new Date : s ? t._d = new Date(+s[1]) : "string" == typeof n ? E(t) : c(n) ? (t._a = n.slice(0), _(t)) : t._d = n instanceof Date ? new Date(+n) : new Date(n)
    }
    ...
    function S(e) {
        var t = e._i, n = e._f;
        return null === t || "" === t ? null : ("string" == typeof t && (e._i = t = d().preparse(t)), R.isMoment(t) ? (e = i({}, t), e._d = new Date(+t._d)) : n ? c(n) ? T(e) : w(e) : C(e), new r(e))
    }
